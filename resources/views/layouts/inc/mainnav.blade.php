<ul class="navbar-nav mr-auto">
    ...
    <li class="nav-item dropdown">
        <a style="color: white; text-decoration: none" class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
            <i class="fas fa-cog"></i> Services Set-up
        </a>
        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
            <a class="dropdown-item" href="{{route('admin.services.index')}}"><i class="fas fa-shopping-basket"></i>  Services</a>
            <a class="dropdown-item" href="{{route('admin.classifications.index')}}"><i class="fas fa-align-justify"></i>  Classifications</a>
            <a class="dropdown-item" href="{{route('admin.transactiontypes.index')}}"><i class="fas fa-clone"></i>  Transaction Types</a>
