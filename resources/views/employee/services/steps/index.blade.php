...
@section('content')
    ...
    <div class="container">
        <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
            <h1 class="h2"> STEPS
                <a class="btn btn-primary" href="{{route('employee.services.steps.add',['id'=>$service->id])}}">
                            ...
                            <tr>
                                ...
                                <td class="text-center" style="background-color: antiquewhite">
                                    <a class="btn btn-secondary btn-sm rounded-circle"
                                       href="{{route('employee.services.steps.agencyactions.add',['id'=>$step->id])}}"><i
                                ...
                                <td style="background-color: antiquewhite">
                                    <a class="btn btn-success btn-sm rounded-circle"
                                       href="{{route('employee.services.steps.agencyactions.index',['id'=>$step->id])}}"><i
                                ...
                                <td class="text-center">
                                    <a class="btn btn-success btn-sm"
                                       href="{{route('employee.services.steps.edit',['id'=>$step->id])}}"><i
                                                class="fas fa-edit"></i> Edit</a>

                                    <a class="btn btn-danger btn-sm"
                                       href="{{route('employee.services.steps.deletestep',['id'=>$step->id])}}"><i
