...
@section('title')
    @include('layouts.inc.title',['title'=>"Services - Agency Actions"])
@endsection
    ...
    <div class="container">
        <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
            <h1 class="h2"> AGENCY ACTIONS
                <a class="btn btn-primary" href="{{route('admin.services.steps.agencyactions.add',['id'=>$step->id])}}">
                    <i class="fas fa-plus-circle fa-lg"></i> Add
                </a>

                <a class="btn btn-dark" href="{{route('admin.services.steps.index',['id'=>$service->id])}}">
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <a class="btn btn-success btn-sm"
                                       href="{{route('admin.services.steps.agencyactions.edit',['id'=>$agencyaction->id])}}"><i
                                                class="fas fa-edit"></i> Edit</a>

                                    <a class="btn btn-danger btn-sm"
                                       href="{{route('admin.services.steps.agencyactions.deleteagencyaction',['id'=>$agencyaction->id])}}"><i
