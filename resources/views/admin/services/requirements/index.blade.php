...
@section('title')
    @include('layouts.inc.title',['title'=>"Services - Requirements"])
@endsection
    ...
    <div class="container">
        <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
            <h1 class="h2"> REQUIREMENTS
                <a class="btn btn-primary" href="{{route('admin.services.requirements.add',['id'=>$service->id])}}">
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <a class="btn btn-success btn-sm"
                                       href="{{route('admin.services.requirements.edit',['id'=>$requirement->id])}}"><i
                                                class="fas fa-edit"></i> Edit</a>

                                    <a class="btn btn-danger btn-sm"
                                       href="{{route('admin.services.requirements.deleterequirement',['id'=>$requirement->id])}}"><i
