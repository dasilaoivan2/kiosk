    ...
    <div class="container">
        <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
            <h1 class="h2"> TRANSACTION TYPES
                <a class="btn btn-primary" href="{{route('admin.services.transactiontypes.add',['id'=>$service->id])}}">
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <a class="btn btn-success btn-sm"
                                       href="{{route('admin.services.transactiontypes.edit',['id'=>$type->id])}}"><i
                                                class="fas fa-edit"></i> EDIT</a>

                                    <a class="btn btn-danger btn-sm"
                                       href="{{route('admin.services.transactiontypes.deletetrans',['id'=>$type->id])}}"><i
